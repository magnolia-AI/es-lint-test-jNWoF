...
export default function Home() {
  ...
  return (
    <div className="min-h-full">
      {/* Hero Section */}
      <section className="relative w-full h-[500px] flex items-center justify-center text-center bg-cover bg-center" style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1588600057198-4c741d4b6849?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)' }}>
        <div className="absolute inset-0 bg-black opacity-50"></div>
        <div className="relative z-10 text-white p-4">
          <h1 className="text-5xl font-bold tracking-tight lg:text-7xl drop-shadow-lg">
      ...
      <section className="container mx-auto px-4 py-20">
        <h2 className="text-4xl font-bold text-center mb-12">Our Delicious Breads</h2>
      ...
      <section className="bg-gray-100 dark:bg-gray-800 py-20">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-6">Baked with Passion, Delivered with Care</h2>
          <p className="text-lg max-w-[800px] mx-auto text-muted-foreground mb-10">
            At our bakery, every loaf tells a story of tradition, quality ingredients, and a dedication to the art of bread making. Taste the difference that true craftsmanship makes.
          </p>
          <Button size="lg">
            Learn More About Us
          </Button>
